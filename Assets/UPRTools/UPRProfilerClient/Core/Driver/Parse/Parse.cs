...
namespace UPRLuaProfiler
{
    public static class Parse
    {
        public static readonly string LOCAL_PROFILER =
            "local BeginMikuSample = UPRLuaProfiler.LuaProfiler.BeginSample "
            + "local EndMikuSample = UPRLuaProfiler.LuaProfiler.EndSample " + "local miku_unpack_return_value = miku_unpack_return_value ";
        #region parse
