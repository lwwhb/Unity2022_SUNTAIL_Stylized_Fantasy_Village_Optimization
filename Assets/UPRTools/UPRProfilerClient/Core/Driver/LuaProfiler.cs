...
namespace UPRLuaProfiler
{
    public static class LuaProfiler
    {
        ...
        public static void BeginSampleCSharp(string name)
        {
            ...
            if (NetWorkClient.enableDeepMono)
            {
                BeginSampleInternal(_mainL, name);
            }
        }
        public static void EndSampleCSharp()
        {
            if (NetWorkClient.enableDeepMono)
                EndSampleInternal(_mainL);
        }
        ...
        {    
            if(NetWorkClient.enableDeepLua)
                BeginSampleInternal(luaState, name, needShow);
        }
        public static void BeginSampleInternal(IntPtr luaState, string name, bool needShow = false)
        {
            if (!IsMainThread)
            {
                return;
        ...
        {
            if (NetWorkClient.enableDeepLua)
                EndSampleInternal(luaState);
        }
        
        public static void EndSampleInternal(IntPtr luaState)
        {
            if (!IsMainThread)
            {
                return;
