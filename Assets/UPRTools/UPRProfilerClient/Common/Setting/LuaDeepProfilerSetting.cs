...
namespace UPRLuaProfiler
{
    ...
    public class LuaDeepProfilerSetting
    {
        ...
        {
#if UNITY_EDITOR
            string text = Utils.ResourceUrl  + "LuaDeepProfilerSettings.bytes";
            if (!Directory.Exists(Utils.ResourceUrl))
            {
                Directory.CreateDirectory(Utils.ResourceUrl);
            }
